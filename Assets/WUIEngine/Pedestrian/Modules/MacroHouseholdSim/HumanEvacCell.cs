...
namespace WUIEngine.Pedestrian
{
    ...
    public class HumanEvacCell
    {
        ...
        public HumanEvacCell(Vector2d nodeCenter, Vector2d cellWorldSize, RouteCollection route, int personsInCell, int cellIndex)
        {
            ...
            Mapbox.Utils.Vector2d v = Mapbox.Unity.Utilities.Conversions.GeoToWorldPosition(routeCollection.GetSelectedRoute().route.Shape[0].Latitude, routeCollection.GetSelectedRoute().route.Shape[0].Longitude, WUInity.WUInityEngine.MAP.CenterMercator, WUInity.WUInityEngine.MAP.WorldRelativeScale);
