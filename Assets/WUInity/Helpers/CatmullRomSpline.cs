...
namespace WUInity
{
    public class CatmullRomSpline
    {
        ...
        public CatmullRomSpline(Vector2[] points, float alpha = 0.5f, float tension = 0.0f)
        {
        ...
        void GetPoints(int i, Vector2[] points, out Vector2 p0, out Vector2 p1, out Vector2 p2, out Vector2 p3)
        {
            if (i - 1 < 0)
            {
        ...
        /// <summary>
        /// Called when user want a Y value based on X placement, usually wanting a Y value at time X.
        /// </summary>
