...
namespace WUInity
{
    public class SaveWUI
    {
        public static void SaveInput(string filename)
        {
        ...
        {
            string input = System.IO.File.ReadAllText(Application.dataPath + "/Resources/_input/" + filename + ".wui");
            if(input != null)
            {
        ...
        public static void SaveOutput(string filename)
        {
            ...
            System.IO.File.WriteAllText(Application.dataPath + "/Resources/_output/" + filename + ".wuiout", json);
        }
        ...
        {    
            string path = Application.dataPath + "/Resources/_input/" + filename + ".rc";
