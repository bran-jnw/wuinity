        ...
        public static FireInput Parse(string[] inputLines, int startIndex, Dictionary<string, int> headerLineIndex)
        {
            ...
            if (inputToParse.TryGetValue(input, out userInput))
            {
                switch (userInput)
                {
                    ...
                    default:
                        ++issues;
                        Engine.MESSAGE(null, Engine.LogType.SimulationError, input + " input " + userInput + " was not recognized." + PREACTInput.pleaseCheckInput);
                        break;
                }
            }
            else
            ...
            {
                ++issues;
                Engine.MESSAGE(null, Engine.LogType.SimulationError, nameof(LcpFile) + " was not specified." + PREACTInput.pleaseCheckInput);
            }
            ...
            {
                ++issues;
                Engine.MESSAGE(null, Engine.LogType.SimulationError, nameof(GraphicalFireInputFile) + " was not specified." + PREACTInput.pleaseCheckInput);
            }
