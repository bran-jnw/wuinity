...
namespace WUIPlatform.Fire
{
    public static class CDT_SolarRadiationLibrary
    {
        ...
        */
         ...
         */
        const double Radians = 0.0174532925199433;
        ...
        static void CDT_CalendarDate(double jdate, ref int year, ref int month, ref int day,
                    ref int hour, ref int minute, ref int second, ref int millisecond)
        {
            ...
            hour = (int)dh;
            dm = 60.0 * (dh - (double)hour);
            minute = (int)dm;
            ds = 60.0 * (dm - (double)minute);
            second = (int)ds;
            ms = 1000.0 * (ds - (double)second);
            millisecond = (int)ms;
            return;
        }
        ...
        static int CDT_DayOfWeek(double jdate)
        {
        ...
        static string[] DayOfWeekAbbreviation =
                { "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" };
        static string CDT_DayOfWeekAbbreviation( int dowIndex )
        {
         ...
         */
        static string[] DayOfWeekName = { "Sunday", "Monday", "Tuesday", "Wednesday",
                "Thursday", "Friday", "Saturday" };
        static string CDT_DayOfWeekName( int dowIndex )
        {
        ...
        static int CDT_DayOfYear(int year, int month, int day)
        {
            ...
            else if (doy > 59 && CDT_LeapYear(year) == 1)
            {
                doy++;
            }
            return (doy);
        ...
        static int CDT_DaysInMonth(int year, int month)
        {            
        ...
        static int CDT_DaysInYear(int year)
        {
            if (year == 1582)
            {
                return (355);
        ...
        static double CDT_DecimalDay(int hour, int minute, int second, int millisecond)
        {
        ...
        static double CDT_DecimalHour(int hour, int minute, int second, int millisecond)
        {
        ...
        static void CDT_EasterDay(int year, ref int month, ref int day)
        {
        ...
        static string CDT_EventName( int eventNumber )
        {            
        ...
        static string CDT_FlagName( int eventNumber )
        {            
            return (FlagName[eventNumber]);
        }
        ...
        static double CDT_FractionalPart(double value)
        {
        ...
        static void CDT_ImproveMoon(ref double t0, out double b)
        {
        ...
        public static double CDT_JulianDate(int year, int month, int day,
        ...
        static int CDT_LeapYear(int year)
        {
        ...
        static double CDT_LocalMeanSiderealTime(double mjd, double lambda)
        {
        ...
        static int CDT_MillisecondOfDay(int hour, int minute, int second, int millisecond)
        {
        ...
        static void CDT_MiniMoon(double t, out double ra, out double dec)
        {
            ...
            dl = 22640.0 * sin(l)
               ...
               + 148.0 * sin(l - ls)
               - 55.0 * sin(2.0* f - 2 * d);
            s = f + (dl + 412.0 * sin(2 * f) + 541.0 * sin(ls)) / arc;
            h = f - 2.0* d;
            n = -526.0 * sin(h)
              + 44.0 * sin(l + h)
              - 31.0 * sin(-l + h)
        ...
        static void CDT_MiniSun(double t, out double ra, out double dec)
        {
        ...
        static double CDT_ModifiedJulianDate(double jdate)
        {
        ...
        static string CDT_MonthAbbreviation( int month )
        {
            if (month >= 1 && month <= 12)
            {
        ...
        static string CDT_MonthName( int month )
        {            
            if (month >= 1 && month <= 12)
            {
        ...
        static double CDT_NewMoonGMT(int year, int period)
        {
            ...
            CDT_ImproveMoon(ref t_new_moon, out b_moon);
            CDT_ImproveMoon(ref t_new_moon, out b_moon);
        ...
        static int CDT_QuadraticRoots(
            double y_minus,     /* in: first y value */
            double y_0,         /* in: second y value */
            double y_plus,      /* in: third y value */
            out double xe,         /* out: x of the extreme value of the parabola */
            out double ye,         /* out: y of the extreme value of the parabola */
            out double zero1,      /* out: first root within [-1, +1] (for nz=1,2) */
            out double zero2       /* out: second root within [-1, +1] (only for nz=2) */
        )
        {
        ...
        static int CDT_RiseSet(int eventNumber, double jdate, double lon, double lat,
                    double gmtDiff, ref double hours)
        {
            double amjd, sinh0;
            double y_minus, y_0, y_plus;
            double xe, ye, zero1, zero2, utset = 0.0, utrise = 0.0, sphi, cphi, hour;
            ...
            amjd = (double)jd - gmtDiff / 24.0;

            /* Determine the parameters for this type of event */
            doRise = 0;
            doSet = 0;
            flag = (int)CDT_Flag.CDT_None;
            switch (eventNumber)
            {
                /* Sunrise at h = -50' */
                case (int)CDT_Event.CDT_SunRise:
                    sinh0 = sn(-50.0 / 60.0);
                    doRise = 1;
                    break;
                case (int)CDT_Event.CDT_SunSet:
                    sinh0 = sn(-50.0 / 60.0);
                    doSet = 1;
                    break;
                    /* Moonrise at h = +8' */
                case (int)CDT_Event.CDT_MoonRise:
                    sinh0 = sn(8.0 / 60.0);
                    doRise = 1;
                    break;
                case (int)CDT_Event.CDT_MoonSet:
                    sinh0 = sn(8.0 / 60.0);
                    doSet = 1;
                    break;
                    /* Civil twilight occurs at -6 degrees */
                case (int)CDT_Event.CDT_CivilDawn:
                    sinh0 = sn(-6.0);
                    doRise = 1;
                    break;
                case (int)CDT_Event.CDT_CivilDusk:
                    sinh0 = sn(-6.0);
                    doSet = 1;
                    break;
                    /* Nautical twilight occurs at -12 degrees */
                case (int)CDT_Event.CDT_NauticalDawn:
                    sinh0 = sn(-12.0);
                    doRise = 1;
                    break;
                case (int)CDT_Event.CDT_NauticalDusk:
                    sinh0 = sn(-12.0);
                    doSet = 1;
                    break;
                    /* Astronomical twilight occurs at -18 degrees */
                case (int)CDT_Event.CDT_AstronomicalDawn:
                    sinh0 = sn(-18.0);
                    doRise = 1;
                    break;
                case (int)CDT_Event.CDT_AstronomicalDusk:
                    sinh0 = sn(-18.0);
                    doSet = 1;
                    break;
                default:
            ...
            cphi = cs(lat);
            hour = 1.0;
            y_minus = CDT_SineAltitude(eventNumber, amjd, hour - 1.0, lon, cphi, sphi) - sinh0;
            above = y_minus > 0.0 ? 1 : 0;
            rise = 0;
            sett = 0;
            ...
            do
            {
                y_0 = CDT_SineAltitude(eventNumber, amjd, hour, lon, cphi, sphi) - sinh0;
                y_plus = CDT_SineAltitude(eventNumber, amjd, hour + 1.0, lon, cphi, sphi) - sinh0;
                nz = CDT_QuadraticRoots(y_minus, y_0, y_plus, out xe, out ye, out zero1, out zero2);
                if (nz == 0)
                {
                }
                else if (nz == 1)
            ...
            if (rise == 1 || sett == 1)
            {
                if (doRise == 1)
                {
                    ...
                    {
                        hours = utrise;
                        flag = (int)CDT_Flag.CDT_Rises;
                    }
                    else
                    {
                        flag = (int)CDT_Flag.CDT_NeverRises;
                    }
                }
                else if (doSet == 1)
                {
                    ...
                    {
                        hours = utset;
                        flag = (int)CDT_Flag.CDT_Sets;
                    }
                    else
                    {
                        flag = (int)CDT_Flag.CDT_NeverSets;
                    }
                }
            }
            ...
            else
            {
                ...
                if (above == 1)
                {
                    if (eventNumber == (int)CDT_Event.CDT_SunRise || eventNumber == (int)CDT_Event.CDT_SunSet
                     || eventNumber == (int)CDT_Event.CDT_MoonRise || eventNumber == (int)CDT_Event.CDT_MoonSet )
                        {
                        flag = (int)CDT_Flag.CDT_Visible;
                    }
                        else
                    {
                        flag = (int)CDT_Flag.CDT_Light;
                    }
                }
                ...
                else
                {
                    if (eventNumber == (int)CDT_Event.CDT_SunRise || eventNumber == (int)CDT_Event.CDT_SunSet
                     || eventNumber == (int)CDT_Event.CDT_MoonRise || eventNumber == (int)CDT_Event.CDT_MoonSet )
                        {
                        flag = (int)CDT_Flag.CDT_Invisible;
                    }
                        else
                    {
                        flag = (int)CDT_Flag.CDT_Dark;
                    }
                }
            }
            return (flag);
        ...
        static double CDT_SineAltitude(int eventNumber, double mjd0, double hour,
            double lambda, double cphi, double sphi)
        {
            ...
            /* Moon times */
            if ( eventNumber == (int)CDT_Event.CDT_MoonRise || eventNumber == (int)CDT_Event.CDT_MoonSet )
            {
            CDT_MiniMoon(t, out ra, out dec);
        }
            /* Sun times */
            else
        {
            CDT_MiniSun(t, out ra, out dec);
        }
        ...
        static double CDT_SolarAngle(double slope, double aspect, double altitude,
                    double azimuth)
        {
        ...
        public static double CDT_SolarRadiation(double jdate, double lon, double lat, double gmtDiff,
                    ...
                    double canopyTransmittance)
        {
            ...
            CDT_SunPosition(jdate, lon, lat, gmtDiff, out alt, out azim);
        ...
        static double CDT_SolsticeGMT(int eventNumber, int year)
        {            
            double y;
            int i;

            /* Determine the event parameter set */
            if ( eventNumber == (int)CDT_Event.CDT_Spring )
            {
                i = 0;
            }
            else if (eventNumber == (int)CDT_Event.CDT_Summer )
            {
                i = 1;
            }
            else if (eventNumber == (int)CDT_Event.CDT_Fall )
            {
                i = 2;
            }
            else if (eventNumber == (int)CDT_Event.CDT_Winter )
            {
                i = 3;
            }
            else
        ...
        static void CDT_SunPosition(double jdate, double lon, double lat,
                double gmtDiff, out double altitude, out double azimuth)
        {
            double mjd, ra, dec, t, tau;
            double sinPhi, cosPhi, sinDec, cosDec, cosTau, sinAlt;

            /* Modified Julian date adjusted for GMT difference */
            mjd = jdate - 2400000.5 - (gmtDiff / 24.0 );
        ...
        static int CDT_ValidDateTime(int year, int month, int day,
                int hour, int minute, int second, int millisecond)
        {
            int flag;
            if ((flag = CDT_ValidDate(year, month, day)) != (int)CDT_Flag.CDT_HasValidDate)
            {
                return (flag);
            }
            if ((flag = CDT_ValidTime(hour, minute, second, millisecond)) != (int)CDT_Flag.CDT_HasValidTime)
            {
                return (flag);
            }
            return ((int)CDT_Flag.CDT_HasValidDateTime);
        }
        ...
        static int CDT_ValidDate(int year, int month, int day)
        {
            if (year < -4712)
            {
                return ((int)CDT_Flag.CDT_HasInvalidYear);
            }
            if (month < 1 || month > 12)
            {
                return ((int)CDT_Flag.CDT_HasInvalidMonth);
            }
            if (day < 1 || day > CDT_DaysInMonth(year, month))
            {
                return ((int)CDT_Flag.CDT_HasInvalidDay);
            }
            ...
            return ((int)CDT_Flag.CDT_HasValidDate);
        }
        ...
        static int CDT_ValidTime(int hour, int minute, int second, int millisecond)
        {
            if (hour < 0 || hour > 23)
            {
                return ((int)CDT_Flag.CDT_HasInvalidHour);
            }
            if (minute < 0 || minute > 59)
            {
                return ((int)CDT_Flag.CDT_HasInvalidMinute);
            }
            else if (second < 0 || second > 59)
            {
                return ((int)CDT_Flag.CDT_HasInvalidSecond);
            }
            else if (millisecond < 0 || millisecond > 999)
            {
                return ((int)CDT_Flag.CDT_HasInvalidMillisecond);
            }
            return ((int)CDT_Flag.CDT_HasValidTime);
        }
    }
}
