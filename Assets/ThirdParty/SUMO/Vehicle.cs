...
public class Vehicle : global::System.IDisposable {
  ...
  public static SWIGTYPE_p_std__vectorT_std__pairT_std__string_double_t_t getNeighbors(string vehID, int mode) {
    SWIGTYPE_p_std__vectorT_std__pairT_std__string_double_t_t ret = new SWIGTYPE_p_std__vectorT_std__pairT_std__string_double_t_t(libsumoPINVOKE.Vehicle_getNeighbors(vehID, mode), true);
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static void setPreviousSpeed(string vehID, double prevspeed) {
    libsumoPINVOKE.Vehicle_setPreviousSpeed(vehID, prevspeed);
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public static void subscribe(string objectID, IntVector varIDs, double begin, double end, TraCIResults params_) {
    libsumoPINVOKE.Vehicle_subscribe__SWIG_0(objectID, IntVector.getCPtr(varIDs), begin, end, TraCIResults.getCPtr(params_));
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public static void subscribeContext(string objectID, int domain, double dist, IntVector varIDs, double begin, double end, TraCIResults params_) {
    libsumoPINVOKE.Vehicle_subscribeContext__SWIG_0(objectID, domain, dist, IntVector.getCPtr(varIDs), begin, end, TraCIResults.getCPtr(params_));
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }
