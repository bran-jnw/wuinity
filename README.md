...
SUMO 1.24 64-bit which therefore has to be installed on your system for it to run (as we do not want to re-distribute SUMO dlls). Make sure to install the version with all the extras as that is where GDAL is included.
