namespace PREACT
{
    public class EngineTask
    {
        ...
        public EngineTask(ExecutionMode Execution, int numberOfRuns, int simulationIndexOffset = 0, int batchSize = 4, bool stopAfterConverging = true, int convergenceMinSequence = 10, float convergenceMaxDifference = 0.02f)
        {
