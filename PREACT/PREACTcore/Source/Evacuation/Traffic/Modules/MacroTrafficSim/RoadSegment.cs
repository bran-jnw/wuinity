    ...
    public class RoadSegment
    {
        ...
        public void CalculateSpline(MacroVehicle vehicle, Simulation simulation)
        {
            ...
            for (int i = 0; i < points; i++)
            {
                ...
                Vector2d simulationPos = simulation.Spatial.GetSimulationPosition(new Vector2d(coordinate.Latitude, coordinate.Longitude));
                if (i > 0)
                {
        ...
        public float CalculateSpeedBasedOnDensity(MacroTrafficSim mCS, Simulation simulation)
        {
            ...
            if (tO.VisibilityAffectsSpeed)
            {
                ...
                float D_L = simulation.Hazards.SmokeModule.GetSootDensityAtCoordinate(new Vector2d(goalCoord.Latitude, goalCoord.Longitude));
