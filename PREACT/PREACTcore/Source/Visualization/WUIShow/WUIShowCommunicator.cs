...
namespace PREACT.Visualization
{
    public class WUIShowCommunicator
    {
        ...
        {            
            Evacuation.EvacuationDestination[] destinations = _engine.Simulation.Evacuation.DestinationsArray;
        ...
        public byte[] CreateTcpHeader(string message, long dataLength)
        {
            ...
            Array.Copy(messageBytes, 0, paddedMessage, 0, Mathf.Min(messageBytes.Length, 24));
